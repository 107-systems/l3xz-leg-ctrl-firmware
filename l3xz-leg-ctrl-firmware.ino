...
void setup()
{
  ...
  size_t const RXMB0_FILTER_SIZE = 1; /* Up to 2. */
  ...
  size_t const RXMB1_FILTER_SIZE = 0; /* Up to 4. */
  mcp2515.enableFilter(MCP2515::RxB::RxB1, RXMB1_MASK, nullptr, RXMB1_FILTER_SIZE);
